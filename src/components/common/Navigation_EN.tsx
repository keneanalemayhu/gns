...
// @/components/common/Navigation_EN.tsx
...
export default function Navigation_EN() {
  ...
  const navItems = [
    { name: "Solar", href: "/en/solar" },
    { name: "Construction", href: "/en/construction" },
    { name: "Medical", href: "/en/medical" },
    { name: "Industrial Chemicals", href: "/en/industrial" },
  ];
  ...
  return (
    <nav className="fixed top-0 w-full z-40 backdrop-blur-xl bg-white/70 dark:bg-black/40 border-b border-white/10 dark:border-white/20">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* LOGO */}
        <Link href="/en" className="flex items-center gap-2 text-xl font-semibold">
