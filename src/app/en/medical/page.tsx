  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-neutral-900 text-gray-900 dark:text-gray-100">
      ...
      <section className="relative h-[60vh] w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-lg max-w-2xl mx-auto text-gray-200 drop-shadow">
            Reliable diagnostic devices, patient-care equipment, consumables, and
            lab essentials for hospitals, clinics, pharmacies & NGOs across Ethiopia.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-32">
        ...
        {/* ABOUT */}
        <section>
          <h2 className="text-3xl font-bold mb-6">About Our Medical Division</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-4 text-lg leading-relaxed">
              <p>
                GNS Trading supplies high-quality medical equipment sourced from certified
                global manufacturers. We serve hospitals, clinics, pharmacies, diagnostic
                labs, NGOs, and home-care providers across Ethiopia.
              </p>

              <p>
                Our catalogue includes diagnostic devices, PPE, consumables, oxygen systems,
                patient-care equipment, and lab essentials.
              </p>

              <p>
                We focus on reliability, affordability, and fast delivery — ensuring our
                customers receive medical products they can trust.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* FEATURED PRODUCTS */}
        <section>
          <h2 className="text-3xl font-bold mb-10">Featured Medical Products</h2>

          <div className="grid md:grid-cols-3 gap-10">
            {[
              {
                title: "Digital Thermometer",
                desc: "Fast-reading, accurate thermometers suitable for clinics and hospitals.",
                img: "/medical/thermometers.jpg",
                alt: "Thermometer",
              },
              {
                title: "Blood Pressure Monitor",
                desc: "High-precision BP monitors for accurate patient diagnosis.",
                img: "/medical/bpm.jpg",
                alt: "BP Monitor",
              },
              {
                title: "Laboratory Set",
                desc: "Essential equipment for diagnostic laboratories and research centers.",
                img: "/medical/lab.jpg",
                alt: "Lab Equipment",
              },
            ].map((item) => (
        ...
        {/* CATEGORIES */}
        <section>
          <h2 className="text-3xl font-bold mb-6">Medical Equipment Categories</h2>
            ...
            {[
              ...
              >
                <div className="grid grid-cols-2 gap-2 mb-3">
                  <img src={cat.images[0]} className="h-24 w-full rounded-lg object-cover" />
                  <img src={cat.images[1]} className="h-24 w-full rounded-lg object-cover" />
                </div>
        ...
        <section className="text-center mt-20">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-6">
            Contact us for quotations, availability, and bulk orders. We deliver reliably
            to hospitals, clinics, pharmacies & NGOs nationwide.
          </p>
