  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-neutral-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-32">
        {/* ABOUT */}
        <section>
          <h2 className="text-3xl font-bold mb-6">{t("medical.about.title")}</h2>

          <div className="grid md:grid-cols-2 gap-12">
            <div className="w-full h-80 rounded-xl overflow-hidden shadow-md">
              <img
                src="/medical/about.jpg"
                alt={t("medical.about.imageAlt")}
                className="w-full h-full object-cover"
              />
            </div>

            <div className="space-y-4 text-lg leading-relaxed">
              <p>{t("medical.about.p1")}</p>
              <p>{t("medical.about.p2")}</p>
              <p>{t("medical.about.p3")}</p>
            </div>
          </div>
        </section>
        ...
        <section>
          <h2 className="text-3xl font-bold mb-10">
            {t("medical.featured.title")}
          </h2>

          <div className="grid md:grid-cols-3 gap-10">
            {t("medical.featured.items").map((item: any) => (
              <div
                key={item.title}
        ...
        <section>
          <h2 className="text-3xl font-bold mb-6">
            {t("medical.whyChooseUs.title")}
          </h2>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {t("medical.whyChooseUs.items").map((item: any) => (
              <div
                key={item.title}
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              const cat = t(`medical.categories.${key}`);
        ...
        <section className="text-center mt-20">
          <h2 className="text-3xl font-bold mb-4">{t("medical.cta.title")}</h2>
