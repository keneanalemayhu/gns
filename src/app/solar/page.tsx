            ...
            <section className="relative h-[60vh] w-full flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6">
                    ...
                    <p className="text-lg max-w-2xl mx-auto text-gray-200 drop-shadow">
                        High-efficiency solar systems for homes, businesses, farms, and EV charging stations.
                    </p>
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-6 py-20 space-y-32">
                ...
                <section>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        {/* Image Placeholder */}
                        <div className="w-full h-72 bg-gray-300 dark:bg-neutral-800 rounded-xl animate-pulse" />

                        <div className="space-y-4 text-lg leading-relaxed">
                            <p>
                                At GNS Trading, we are committed to providing high-quality solar solutions
                                that power the future. As a leading supplier of solar panels and related
                                equipment, we serve homes, businesses, and agricultural sectors by helping
                                them harness renewable energy.
                            </p>
                            <p>
                                Our mission is to make solar power accessible, affordable, and sustainable
                                for everyone. With strong supplier networks and deep local market knowledge,
                                we deliver reliable products, expert installation, and ongoing maintenance.
                            </p>
                            <p>
                                Whether you&rsquo;re reducing energy bills or improving energy independence,
                                GNS Trading is your trusted partner in Ethiopia’s solar industry.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="space-y-10 text-lg leading-relaxed">
                        <p>
                            We supply a full range of solar panels, mounting systems, inverters, and
                            batteries for residential, commercial, and agricultural installations.
                        </p>

                        <ul className="list-disc ml-6 space-y-2">
                            <li><strong>Solar Panels:</strong> High-efficiency panels for homes, businesses & farms.</li>
                            <li><strong>Mounting Systems:</strong> Roof-mounted, ground-mounted & carport systems.</li>
                            <li><strong>Apartments & Malls:</strong> Adjustable tilt-roof systems for maximum efficiency.</li>
                            <li><strong>EV Charging Stations:</strong> Aluminum carport mounting structures.</li>
                            <li><strong>Farming Systems:</strong> East-West ground-mounting structures.</li>
                            <li><strong>Inverters & Batteries:</strong> High-performance storage systems for reliable backup.</li>
                        </ul>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <div className="bg-white dark:bg-neutral-800 rounded-xl border dark:border-neutral-700 shadow-sm p-6">
                            <div className="w-full h-48 bg-gray-300 dark:bg-neutral-700 rounded-lg mb-4 animate-pulse" />
                            ...
                            <ul className="list-disc ml-5 space-y-2 text-sm">
                                ...
                                <li><strong>Key Features:</strong> Adjustable angle, weather-resistant, low maintenance.</li>
                                <li><strong>Benefits:</strong> Higher energy production, lower electricity costs.</li>
                                <li><strong>Specs:</strong> Aluminum material, 10°–30° adjustable tilt.</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white dark:bg-neutral-800 rounded-xl border dark:border-neutral-700 shadow-sm p-6">
                            ...
                            <ul className="list-disc ml-5 space-y-2 text-sm">
                                ...
                                <li>
                                    <strong>Key Features:</strong> Strong aluminum frame, fast installation.
                                </li>
                                <li>
                                    <strong>Benefits:</strong> Grid reduction, vehicle protection, sustainability.
                                </li>
                                <li>
                                    <strong>Specs:</strong> High-strength aluminum, customizable capacity.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white dark:bg-neutral-800 rounded-xl border dark:border-neutral-700 shadow-sm p-6">
                            ...
                            <ul className="list-disc ml-5 space-y-2 text-sm">
                                ...
                                <li><strong>Key Features:</strong> Corrosion-resistant, fast installation.</li>
                                <li><strong>Benefits:</strong> Reduced farm energy costs & energy independence.</li>
                                <li><strong>Specs:</strong> Galvanized steel & aluminum, ground-mounted.</li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <div className="space-y-4 text-lg">
                        <p>
                            We provide full-service solar solutions — installation, maintenance, and system planning —
                            delivered by a certified team of engineers and technicians.
                        </p>
                    </div>
